...
def reflection(tree1, tree2):
	if ((tree1 is None) and (tree2 is None)):
		return True
	if (tree1 is None or tree2 is None):
		return False
	if (tree1.val == tree2.val):
		return (reflection(tree1.left, tree2.right) and reflection(tree1.right, tree2.left))
	return False

def mirror_tree(tree):
	if (tree is None):
		return True 
	return reflection(tree.left, tree.right)
...
print (mirror_tree(node1)) #should return true
print (mirror_tree(node2)) #should return false